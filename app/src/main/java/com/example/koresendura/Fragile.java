...
public class Fragile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        labeltype = (TextView) findViewById(R.id.labeltextfragile);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragile.this.startActivity(myIntent);
            }
        });
...
//				        		HPRTPrinter=null;
    ...
    public void print(View view) {
        ...
        EditText copy=(EditText) findViewById(R.id.copyfragile);
        ...
        try {
            ...
            if (inputcopy.length() == 0) {
                ...
                if (labeltype.getText().toString().equals("Fragile")) {
                    String prnfile4 = prnFile.fragile(inputcopy);
                    Toast.makeText(getApplicationContext(), "Fragile", Toast.LENGTH_LONG).show();
...
//				HPRTPrinter=new ZPLPrinterHelper(thisCon,arrPrinterList.getItem(spnPrinterList.getSelectedItemPosition()).toString());
    ...
    public void backtoselect(View view) {
        Intent myIntent = new Intent(Fragile.this, selectsize.class);
        Fragile.this.startActivity(myIntent);
